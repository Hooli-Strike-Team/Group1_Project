...
* In Progress 
    ...
    * Micah: Build Make an Account page. Working on moving CSS style formatting to the common CSS stylesheet.
    * Ben:...
    * Paul: 
...
* To Do 
    * Matt: ...
    * Micah: Work on the E/R Diagram. Finish the Project Milestone 5 (SQL Design) entries for the 
    * Ben:...
