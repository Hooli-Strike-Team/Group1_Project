...
* To Do
  ...
  * Micah: Create a user-experience graph using the mock-up pages designed by Tory and Paul. Expected to complete this effort by Thursday (14Mar2023)   
  * Ben: ...
...
* To Do 
    * Matt: ...
    * Micah: Gain access to mock-ups created by Tory and Paul, and start creating a user experience diagram in the form of a user story graph.
    * Ben: ... 
...
* Completed 
    * Matt: ...
    * Micah: Gained access to "moqups" info-visualization tools, working with Tory and Paul to understand these tools and determining the best way to cooperate on the mock-up and diagramming efforts. 
    * Ben: ... 
    * Paul: ...
    * Tory: ...
...
* In Progress 
    * Matt: ...
    * Micah: Working on building a graph for the user story-board to describe the expected user experience paths for the application. For example, "As a user with no account, when I land on the application homepage I see..." "When I click the 'create a login' hyperlink, I am directed to..." "etc."
    * Ben: ... 
    * Paul: ...
    * Tory: ...
