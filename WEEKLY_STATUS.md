...
* Completed 
    ...
    * Ben: Edited and completed Milestone 4, revisions for formatting, etc. 
    * Paul:  
    * Tory: created mockups to display several monochromatic color scheme options
...
* Completed 
    * Matt: ...
    * Micah: Completed the login page HTML and CSS. 
    * Ben: N/A
    ...
    * Tory: built Home Page and Difficulty Page
    
* In Progress 
    * Matt: Milestone 5 - Creating ER diagram and table descriptions
    * Micah: Build "Make an Account" page. Work on moving CSS style formatting to the common CSS stylesheet.
    * Ben:N/A
    * Paul: 
    ...
    * Tory: helping incorporate new content into pages 

* To Do 
    * Matt: Work on Achievement_Stats entry for Milestone 5
    * Micah: Work on the E/R Diagram. Finish the Project Milestone 5 (SQL Design) entries for the Login and Create Account pages. 
    * Ben: Begin Milestone 5 SQL_TESTING.md Games page 
...
* Completed 
    * Matt: Completed Achievement_Stats entry for Milestone 5
    * Micah: Completed five revisions of the Project Milestone 5 ER diagram with input from the group.  Version one was generated by   Matt. 
    * Ben:  
    * Paul: 
        * Finished the Achievements page for Milestone 5 
        * On Trello, layed out the remaining tasks that are needed to complete the project 
    * Tory: Built Home Page and Difficulty Page
    
* In Progress 
    * Matt: Work with Paul to coordinate Achievement_Stats/Achievments SQL
    * Micah: Waiting for team feedback about v2 of the ER diagram. Working on Login and Create Account pages of the Project Milestone 5 document.
    * Ben: Milestone 5 SQL_TESTING.md, GAMES page  
    * Paul: Planning out the remaining tasks need to be implemented to complete project before the end of the semester. 
    * Tory: working on GameSettings table for Milestone 5 

* To Do 
    * Matt: Javascript implementation of Sudoku game.
    * Micah: Finish assigned sections of Milestone 5 and coordinate with group about pending SQL design choices.
    * Ben: Finish Milestone 5 before due date 
    * Paul: Complete the Achievements table for Milestone 5. 
...
* Completed 
    * Matt: Completed Milestone 5 SQL document.
    * Micah: Finished SQL Design Project Milestone 5 document with the rest of the group prior to the deadline. Integrated Login page with the Jinja template. 
...
* In Progress 
    ...
    * Micah: Writing HTML/CSS for the Create Account page and integrating it into the Jinja template. Begin writing flask routes for Login and Create Account pages. 
